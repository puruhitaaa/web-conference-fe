...
export const protectedRoutes = {
  ...
  loas: `${apiConfig.baseUrl}/loas`,
  loaHistory: `${apiConfig.baseUrl}/loas/history`,

  // Payment routes (owned resources)
  invoices: `${apiConfig.baseUrl}/invoices`,
  receipts: `${apiConfig.baseUrl}/receipts`,
  payments: `${apiConfig.baseUrl}/payments`,
